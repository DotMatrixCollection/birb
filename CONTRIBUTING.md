# Contributing to birb

Bug reports and pull requests are welcome on GitHub at [https://github.com/OhMyRuby/birb](https://github.com/OhMyRuby/birb).

## Set up the environment

1. Fork the project to your GitHub account.
2. Clone the fork with `git clone git@github.com:[your_username]/birb.git`.
3. Run `bundle install`.
4. Run `bundle exec rake` to make sure tests pass locally.

## Run integration tests

If your changes affect component rendering, such as the autocompletion's dialog/dropdown, you may need to run the integration tests, known as `yamatanooroti`.
...
The upstream IRB documentation is generated by [RDoc](https://ruby.github.io/rdoc/) and published to [ruby.github.io/irb](https://ruby.github.io/irb/). Most of the documentation source lives under the `doc/` directory, and this fork currently still tracks that doc set.
